...
The total value of the prizes for this competition is USD$15,000.
...
1. Best Enterprise Distributed Application Prize - 3 prizes
2. Azure Enterprise Distributed Application Prize - 1 prize
3. Developers Choice Awards: Best Reusable Entity - 10 prizes

**Category 1. Best Enterprise Distributed Application Prize** 

   Juried competition to choose the best 3 Enterprise Distributed Applications built with Microsoft Visual Studio, .NET, C# and the NEO Persistable Classes Platform on the NEO Blockchain.
   ...
   * The Best Enterprise Distributed Application Prize is independent of the other competition categories. A project is required to make a separate submission for each category. It is possible for a project to win in multiple categories.
 ...
 **Category 1. Best Enterprise Distributed Application Prize - Submission Requirements**
   
   a. For Reusable Entity development, your project must use Microsoft Visual Studio, .NET, C#, and the NEO Persistable Classes Platform (NPC Compiler) to create each Reusable Entity class.
   ...
   **Category 2. Azure Enterprise Distributed Application Prize** 

   Juried competition to choose the best Enterprise Distributed Application deployed on Microsoft Azure using Microsoft Visual Studio, .NET, C# and the NEO Persistable Classes Platform on the NEO Blockchain.

   One or more of your enterprise distributed application's software tiers must be deployed on Microsoft Azure.

   * There is one (1) Azure Enterprise Distributed Application Prize.
   ...
   * Submissions will be independently voted on and selected by three (3) or more members of the the Microsoft Azure, Visual Studio and .NET product teams.

   * Submissions will be judged based on, but not limited to, the following criteria: 
      
      a) Leveraging the value-added [Microsoft Azure Services](https://azure.microsoft.com/en-us/services/) such as Database, Web and Mobile, Analytics, AI and Machine Learning, Internet of Things, Enterprise Integration, Security and Identity, and Monitoring and Management.

      b) Leveraging the base [Microsoft Azure Services](https://azure.microsoft.com/en-us/services/) such as Compute, Storage, Containers, and Networking. 
      
      c) Clarity of your project's code, documentation, and videos in terms of how your submission leverages Microsoft Azure Services.

 **Category 2. Azure Enterprise Distributed Application Prize - Submission Requirements**
   
   a. Your submission to this category must also satisfy the Category 1 submission requirements.

   b. In addition to the Category 1 submission requirements, one or more of your distributed application's software tiers must be deployed on Microsoft Azure and use one or more [Microsoft Azure Services](https://azure.microsoft.com/en-us/services/).

**Category 3: Developers Choice Awards: Best Reusable Entity** 

   * NPC Reusable Entities will be voted on by all members of the projects that enter a submission to any category of this competition.

   * The ten (10) Reusable Entities with the most votes will each win one prize.

      | Prize | Value |
      | ----- | ----- |
      | 10 prizes | USD$100 each |

   * The Developers Choice Awards: Best Reusable Entity is independent of the other competition categories. A project is required to make a separate submission for each category. It is possible for a project to win in multiple categories.

   * A project can submit multiple, separate, different Reusable Entities to this category. A project can win more than one Best Reusable Entity prize.

   * When voting for the Best Reusable Entity, developers are asked to keep the following criteria in mind: 
...
**Category 3: Developers Choice Awards: Best Reusable Entity -  Submission Requirements**
   
   a. For Reusable Entity/smart contract development, your project must use Microsoft Visual Studio, .NET, C# and the NEO Persistable Classes Platform (NPC Compiler) to create each Reusable Entity class.

   b. Each of your Reusable Entity's methods must successfully and reliably execute using 10 NeoGas (GAS) or less.
   
   c. If you want to submit a Reusable Entity without developing a submission for the competition categories, this is possible as long as another Enterprise Distributed Application project uses your Reusable Entity as part of its submission.
   ...
   e. Reusable Entities submitted as part of a submission to the other competition categories must be submitted separately to the Developers Choice Awards: Best Reusable Entity category.
