...
* Smart contracts are built as plain-old C# class projects. The NEO Compiler is run as a Visual Studio post-build step to transcompile MSIL patterns from the standard .NET assembly (DLL file) into a .AVM NEO VM byte code file.
